...
class _InspectionScreenState extends State<InspectionScreen> {
  ...
  // Example soil/production data for each operation
  ...
  Future<void> sendImageToBackend() async {
    ...
    if (pickedFile != null) {
      ...
      final response = await http.post(
        Uri.parse("http://172.25.25.140:8000/process_frame"),
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                _buildStatCard("Insect", "Normal Level", "18%", Colors.green),
                _buildStatCard("Water", "Normal Level", "74%", Colors.green,
                    isHighlighted: true),
                      ...
                      builder: (context) => Scaffold(
                        ...
                        body: const Center(
                          child: IPhoneCameraStream(
                            streamUrl: "http://172.25.25.140:8000/video_feed", // 👈 your backend stream
                          ),
                        ),
                      ),
                    ),
